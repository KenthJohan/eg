...
char const *lws_callback_reasons_tostr(enum lws_callback_reasons reason)
{
	switch(reason)
	{
		...
		#ifdef LWS_CALLBACK_CLIENT_HTTP_REDIRECT
		case LWS_CALLBACK_CLIENT_HTTP_REDIRECT:return"LWS_CALLBACK_CLIENT_HTTP_REDIRECT";
		#endif
		...
		#ifdef LWS_CALLBACK_MQTT_UNSUBSCRIBE_TIMEOUT
		case LWS_CALLBACK_MQTT_UNSUBSCRIBE_TIMEOUT:return"LWS_CALLBACK_MQTT_UNSUBSCRIBE_TIMEOUT";
		#endif
		#ifdef LWS_CALLBACK_MQTT_SHADOW_TIMEOUT
		case LWS_CALLBACK_MQTT_SHADOW_TIMEOUT:return"LWS_CALLBACK_MQTT_SHADOW_TIMEOUT";
		#endif
