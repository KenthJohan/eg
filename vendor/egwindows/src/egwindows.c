...
void EgWindowsImport(ecs_world_t *world)
{
	...
	{.name = "canvas_mouse_x", .type = ecs_id(ecs_f32_t)},
	{.name = "canvas_mouse_y", .type = ecs_id(ecs_f32_t)},
	{.name = "canvas_width", .type = ecs_id(ecs_f32_t)},
	{.name = "canvas_height", .type = ecs_id(ecs_f32_t)},
