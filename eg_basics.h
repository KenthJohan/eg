...
static void eg_iter_info(ecs_iter_t *it, const char *fname, const char *file, int32_t line)
{
	...
	for (int i = 0; i < it->count; i ++)
	{
		...
		file, line, fname, e, ecs_get_name(world, e), ecs_type_str(world, ecs_get_type(world, e))
		);
	}
}
