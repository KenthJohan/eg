...
void test_identity(void)
{
	...
	printf("✓ Identity quaternion test passed\n");
}
...
void test_xyza(void)
{
	...
	printf("✓ Quaternion axis-angle creation test passed\n");
}
...
void test_mul_identity(void)
{
	...
	printf("✓ Quaternion identity multiplication test passed\n");
}

// Test quaternion multiplication associativity
void test_mul_associativity(void)
{
	...
	printf("✓ Quaternion multiplication associativity test passed\n");
}

// Test vector rotation
void test_rotate_vector_identity(void)
{
	float identity[4] = QF32_IDENTITY;
	...
	printf("✓ Quaternion identity vector rotation test passed\n");
}

// Test 90 degree rotation around Z axis
void test_rotate_vector_z_90(void)
{
	float q[4];
	qf32_xyza(q, 0.0f, 0.0f, 1.0f, M_PI / 2.0f);
	...
	printf("✓ Quaternion Z-axis 90° rotation test passed\n");
}

// Test 180 degree rotation around X axis
void test_rotate_vector_x_180(void)
{
	float q[4];
	...
	printf("✓ Quaternion X-axis 180° rotation test passed\n");
}

// Test quaternion to matrix conversion identity
void test_unit_to_m4_identity(void)
{
	float identity[4] = QF32_IDENTITY;
	m4f32 m;
	...
	printf("✓ Quaternion to 4x4 matrix conversion (identity) test passed\n");
}

// Test quaternion to 3x3 matrix conversion
void test_unit_to_m3_identity(void)
{
	float identity[4] = QF32_IDENTITY;
	m3f32 m;
	...
	printf("✓ Quaternion to 3x3 matrix conversion (identity) test passed\n");
}

// Test euler angle conversion
void test_from_euler_zero(void)
{
	float q[4];
	...
	printf("✓ Quaternion from euler angles (zero) test passed\n");
}

// Test euler angle conversion with 90 degree roll
void test_from_euler_roll_90(void)
{
	float q[4];
	...
	printf("✓ Quaternion from euler angles (roll 90°) test passed\n");
}

// Test multiple rotations composition
void test_composed_rotations(void)
{
...
// Main test1 runner for all tests
void test1(void)
{
	test_identity();
	test_xyza();
