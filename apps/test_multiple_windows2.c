...
static void frame(int disp_width, int disp_height, float t, uint32_t frame_count)
{
	state.rx += 0.25f * t;
	state.ry += 0.5f * t;
	...
	sg_begin_default_pass(&state.pass_action, disp_width, disp_height);
